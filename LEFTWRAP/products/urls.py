...
urlpatterns = [
    ...
    path('<int:product_pk>/detail/', views.product_detail, name='product_detail'),
    ...
    path('sales/<int:sale_pk>/detail/', views.sale_detail, name='sale_detail'),
    path('sales/<int:sale_pk>/edit/', views.sale_edit, name='sale_create'),
    path('sales/<int:sale_pk>/delete/', views.sale_delete, name='sale_delete'),
    path('sales/<int:sale_pk>/update/', views.sale_update, name='sale_update'),
    path('sales/<int:sale_pk>/like/', views.sale_like, name='sale_like'),
